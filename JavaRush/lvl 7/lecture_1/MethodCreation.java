...
// how to create and call functions/methods in Java
// on some examples of sorting
public class MethodCreation {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("bubble / insertion / selection");

            type = sc.nextLine();
        } while (!type.equals("bubble") && !type.equals("insertion") && !type.equals("selection"));

        if (type.equals("bubble")) {
            sortBubble(array); // using bubble sort method
            System.out.println(type + " sort: " + Arrays.toString(array));
        }

        if (type.equals("insertion")) {
            sortInsertion(array); // using insertion method
            System.out.println(type + " sort: " + Arrays.toString(array));
        }

        if (type.equals("selection")) {
            sortSelection(array); // using selection method
            System.out.println(type + " sort: " + Arrays.toString(array));
        }
