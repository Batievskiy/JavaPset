// INVENTION_DAY - contains invention date of unique artifact
// create method isTeleportInvented() - to compare date from argument with INVENTION_DAY
// if currentDate is after -> print "you can take the teleport"
// if currentDate is before -> print "sorry, teleport hasn't been invented yet"
// and wait for 10 years (add it to currentDate)

import java.util.Calendar;
import java.util.GregorianCalendar;

public class SolutionLvl17L3v1 {
